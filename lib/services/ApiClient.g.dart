...
class _ApiClient implements ApiClient {
  ...
  @override
  Future<BaseResponse<dynamic>> setDefaultAddress(data) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      contentType: 'application/x-www-form-urlencoded',
            ...
            .compose(
              _dio.options,
              'Api_controller/SetDefaultAddress',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  @override
  Future<BaseResponse<List<RestaurantModel>>> loadRestaurants(data) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(data);
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<BaseResponse<List<RestaurantModel>>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: 'application/x-www-form-urlencoded',
            ...
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = BaseResponse<List<RestaurantModel>>.fromJson(
      _result.data!,
      (json) => (json as List<dynamic>)
          .map<RestaurantModel>(
